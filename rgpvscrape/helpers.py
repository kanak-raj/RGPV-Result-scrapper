...
def gen_roll_num_list(college_code, branch, year, roll_num_range):
    ...
    base_roll_num = college_code + branch + str(year)
...
def solve_captcha(image):
    ...
    # print(tess_config)
    captcha_txt = pytesseract.image_to_string(Image.open('a.jpeg'),config='',lang='eng').upper().replace(' ','')
    
    print(captcha_txt.strip())
    print("AAAA")
    return captcha_txt.strip()
